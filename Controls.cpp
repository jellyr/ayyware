...
void CCheckBox::Draw(bool hover)
{
	...
	if (hover)
	{
		if (Checked)
		{
			Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(255, 0, 0, 255));
		}
		else
		{
...
{
	POINT a = GetAbsolutePos();
	Render::Text(a.x, a.y, Color(0, 0, 0, 255), Render::Fonts::MenuBold, Text.c_str());
}
...
void CGroupBox::Draw(bool hover)
{
	...
	Render::Clear(a.x+2, a.y+2, m_iWidth-4, m_iHeight-4, Color(245,245,245, 255));
	Render::Text(a.x + 15, a.y - (txtSize.bottom / 2), Color(0, 0, 0, 255), Render::Fonts::MenuBold, Text.c_str());
...
void CKeyBind::Draw(bool hover)
{
	...
	Render::Text(a.x + 2, a.y + 2, Color(0, 0, 0, 255), Render::Fonts::MenuBold, KeyName);
}
...
void CComboBox::Draw(bool hover)
{
	...
	{
		// The current item
		Render::Text(a.x + 2, a.y + 2, Color(0, 0, 0, 255), Render::Fonts::MenuBold, GetItem().c_str());
		...
		if (IsOpen)
		{
			...
			for (int i = 0; i < Items.size(); i++)
			{
				...
				Render::Text(a.x + 2, a.y + 19 + i * 16, Color(0, 0, 0, 255), Render::Fonts::MenuBold, Items[i].c_str());
			}
		}
	}
}
